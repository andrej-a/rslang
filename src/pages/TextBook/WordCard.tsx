...
const WordCard = ({
    ...
    useEffect(() => {
        getUserWordByCommonWordId(word.id).then(
            (data: IUserWord | undefined) => {
                setUserWord(data);
            },
        );
    }, [showStat]);
                                ...
                                Math.round(
                                    ((Number(userWord?.optional.rightAudio) +
                                        ...
                                        (Number(userWord?.optional.rightAudio) +
                                            ...
                                            Number(
                                                userWord?.optional.wrongAudio,
                                            ) +
                                            Number(
                                                userWord?.optional.wrongSprint,
                                            ) || 1),
                                ) || 0
                            }
                            color={Colors.WHITE}
                    ...
                    <StatTable imagePath={Sprint} iconColor={Colors.GREEN}>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className="right">
                                    {userWord?.optional.rightSprint ?? 0}
                                </td>
                            </tr>
                            <tr className="wrong">
                                <td></td>
                                ...
                                <td className="wrong">
                                    {userWord?.optional.wrongSprint ?? 0}
                                </td>
                            </tr>
                        </tbody>
                    </StatTable>
                    ...
                    >
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className="right">Right: </td>
                                <td className="right">
                                    {userWord?.optional.rightAudio ?? 0}
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td className="wrong">Wrong: </td>
                                <td className="wrong">
                                    {userWord?.optional.wrongAudio ?? 0}
                                </td>
                            </tr>
                        </tbody>
                    </StatTable>
